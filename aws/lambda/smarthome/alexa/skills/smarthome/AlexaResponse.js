...
class AlexaResponse {
    ...
    createPayloadEndpointCapability(opts) {
       ...
       // capability['capabilityResources'] = {"friendlyNames": [{"@type": "text",  "value": {"text": "acqua fredda", "locale": "it-IT"}}]};
       // capability['capabilityResources'] = {"friendlyNames": [{"@type": "asset",  "value": {"assetId": "Alexa.Setting.Oscillate"}}]};
       // capability['capabilityResources'] = {"friendlyNames": [{"@type": "asset",  "value": {"assetId": "Alexa.Setting.FanSpeed"}}]};
       // capability['configuration'] = {"supportedRange": {"minimumValue": 1, "maximumValue": 4, "precision": 1}};
        
        if (this.checkValue(opts.instance, "") != "") {
            capability['instance'] = opts.instance;
        }
        let friendlyNames = this.checkValue(opts.friendlyNames, false);
        if (friendlyNames) {
            capability['capabilityResources'] = {};
            capability['capabilityResources']['friendlyNames'] = friendlyNames;
        }
